...
export const patientServices: PatientService[] = [
  ...
  },
  {
    ...
    image: '/logo.jpeg', // TODO: Replace with actual service image
    title: 'اسأل طبيب',
    tagline: 'استشارتك الأولى علينا — رد خلال 15 دقيقة',
    description:
      'ولدك حرارته عالية؟ عندك ألم ما تدري سببه؟ اسأل طبيب متخصص الحين واحصل على رد موثوق (صوتي أو مرئي) خلال 15 دقيقة — الاستشارة الأولى علينا لكل زائر جديد.',
    features: [
      { text: 'الاستشارة الأولى علينا — جرّب بدون ما تدفع ريال', verified: true },
      { text: 'رد خلال 15 دقيقة من أطباء معتمدين من جميع الجنسيات', verified: true },
      { text: 'استشارات غير محدودة للمشتركين في باقة بريمير وVIP', verified: true },
    ],
    cta: {
