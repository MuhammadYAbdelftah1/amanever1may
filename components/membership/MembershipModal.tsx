...
const packages: Package[] = [
  {
    ...
    name: 'الباقة الفردية',
    price: '299',
    description: 'مثالية للأفراد | 299 ريال/سنة',
    image: '/logo.jpeg',
    badge: 'الأكثر شعبية',
    badgeColor: 'bg-emerald-500',
    ctaText: 'اشترك الآن',
    ctaHref: '/ar/register?plan=individual',
    notification: 'صحتك أولوية.. ابدأ رحلة الرعاية بذكاء ووفر مع كل خطوة!',
    features: [
      '✔️ 1,500 نقطة أمان: ترحيبية في محفظتك جاهزة للاستخدام الفوري.',
      '✔️ كاش باك 5%: على خدماتك.. لتبدأ التوفير من اليوم الأول.',
      '✔️ 5 استشارات طبية مجانية: أونلاين لراحتك التامة.',
      '✔️ خصومات حتى 50%: في متجر أمان حصرياً للأعضاء.',
      '✔️ أولوية قصوى: وحجز فوري للمواعيد دون انتظار.',
    ],
  },
  {
    id: 'premium',
    ...
    price: '399',
    description: 'للزوج والزوجة | 399 ريال/سنة',
    image: '/logo.jpeg',
    badge: 'الخيار المفضل',
    badgeColor: 'bg-blue-500',
    ctaText: 'اشترك الآن',
    ctaHref: '/ar/register?plan=premium',
    notification: 'الخيار الأذكى.. رعاية مشتركة لك ولشريك حياتك مع توفير مضاعف.',
    features: [
      '✔️ 3,000 نقطة أمان: في محفظتكم لتغطية احتياجاتكم الصحية.',
      '✔️ كاش باك 10%: عائد نقدي وتجميع نقاط أسرع بنسبة (1.5x).',
      '✔️ 5 استشارات طبية مجانية: للاطمئنان المستمر على صحتكم.',
      '✔️ تنظيف أسنان مرتين مجاناً: لابتسامة صحية تليق بكم.',
      '✔️ خصومات حصرية: على كافة الخدمات ومراكز الرعاية الطبية.',
    ],
  },
  {
    id: 'gold',
    name: 'الباقة الذهبية',
    price: '799',
    description: 'للأفراد المميزين | 799 ريال/سنة',
    image: '/logo.jpeg',
    badge: 'الأفضل قيمة',
    badgeColor: 'bg-amber-500',
    ctaText: 'اشترك الآن',
    ctaHref: '/ar/register?plan=gold',
    notification: 'رفاهية استثنائية.. باقة صُممت لتمنحك العناية الفائقة والعوائد المستمرة.',
    features: [
      '✔️ 5,000 نقطة أمان: في محفظتك.. استثمار صحي فاخر.',
      '✔️ كاش باك 15%: فوري يعزز رصيدك مع كل خدمة تستخدمها.',
      '✔️ نقاط ولاء مضاعفة (2x): أسرع طريق للحصول على خدماتك المجانية.',
      '✔️ 5 استشارات طبية + تنظيف أسنان: مجاناً بالكامل.',
      '✔️ دعم فني مخصص: لخدمتك على مدار الساعة كعميل VIP.',
    ],
  },
  {
    id: 'seniors',
    name: 'باقة كبار السن',
    price: '599',
    description: 'لرعاية كبار السن | 599 ريال/سنة',
    image: '/logo.jpeg',
    badge: 'تاج الوفاء',
    badgeColor: 'bg-indigo-500',
    ctaText: 'اشترك الآن',
    ctaHref: '/ar/register?plan=seniors',
    notification: 'بركة أيامنا.. خصصنا لهم رعاية فائقة تليق بقدرهم وتضمن راحتهم.',
    features: [
      '✔️ 6,000 نقطة أمان: رصيد فوري في المحفظة مخصص لكافة الفحوصات والخدمات.',
      '✔️ كاش باك 20%: أعلى نسبة استرداد نقدي لدعم تكاليف الرعاية الصحية المستمرة.',
      '✔️ زيارات تمريضية منزلية: متابعة دورية للعلامات الحيوية والسكر والضغط في المنزل.',
      '✔️ أولوية الحجز: مع نخبة من استشاريي أمراض الشيخوخة والطب الباطني.',
      '✔️ خصومات استثنائية: على الأجهزة الطبية المنزلية والمستلزمات العلاجية.',
      '✔️ دعم فني "عناية": فريق مخصص لمساعدة كبار السن أو ذويهم في تنظيم المواعيد.',
    ],
  },
  {
    id: 'family',
    ...
    price: '999',
    description: 'حتى 6 أفراد | 999 ريال/سنة',
    image: '/logo.jpeg',
    badge: 'رعاية شاملة',
    badgeColor: 'bg-emerald-600',
    ctaText: 'اشترك الآن',
    ctaHref: '/ar/register?plan=family',
    notification: 'مظلة الأمان لعائلتك.. التغطية الأقوى التي تكافئك على اهتمامك بمن تحب.',
    features: [
      '✔️ 6,000 نقطة أمان: رصيد متاح للاستخدام لجميع أفراد العائلة.',
      '✔️ كاش باك حصري 20%: ومضاعفة نقاط (2x).. لأنهم يستحقون الأفضل.',
      '✔️ 4 استشارات مجانية + تنظيف أسنان مرتين: لكل فرد في الباقة.',
      '✔️ إدارة حسابات متعددة: من تطبيق واحد بكل سهولة ويسر.',
      '✔️ خصومات عائلية خاصة: ومستمرة طوال العام.',
    ],
  },
  {
    id: 'special-needs',
    ...
    notification: 'أنتم أبطالنا.. ورعايتكم الاستثنائية شرفٌ لنا.',
    features: [
      '✔️ 6,000 نقطة أمان مجانية: لدعم احتياجاتكم الصحية المباشرة.',
      '✔️ كاش باك 10%: تقديراً لكم، يعود لمحفظتكم فوراً.',
      '✔️ 5 استشارات طبية + تنظيف أسنان مرتين: مجاناً بالكامل.',
      '✔️ رعاية خاصة: ومتابعة دورية مستمرة لحالتكم الصحية.',
    ],
  },
  {
    id: 'orphans',
    ...
    notification: 'فخر مجتمعنا.. استثمارنا في صحتكم هو مكسبنا الحقيقي.',
    features: [
      '✔️ 6,000 نقطة أمان مجانية: رصيد فوري للبدء في الرعاية.',
      '✔️ كاش باك 10%: لتوفير دائم ومستمر في الشبكة الطبية.',
      '✔️ تغطية شاملة: طبياً وصحياً في أرقى المراكز المعتمدة.',
      '✔️ دعم نفسي واجتماعي: متكامل يرافقكم في كل مرحلة.',
    ],
  },
  {
    id: 'widows',
    ...
    price: '99',
    description: 'دعم اجتماعي | 99 ريال/سنة',
    image: '/logo.jpeg',
    badge: 'دعم اجتماعي',
    badgeColor: 'bg-pink-500',
    ctaText: 'اشترك الآن',
    ctaHref: '/ar/register?plan=widows',
    notification: 'نحن سندكِ.. معكِ في كل خطوة نحو حياة مطمئنة وأفضل.',
    features: [
      '✔️ 6,000 نقطة أمان: في محفظتك لاستخدامها متى شئتِ.',
      '✔️ كاش باك 10%: يدعم ميزانيتك ويريح بالك.',
      '✔️ تغطية طبية وصحية شاملة: بالإضافة إلى 5 استشارات مجانية.',
      '✔️ دعم نفسي وبرامج تأهيل: وتدريب مستمر لتمكينكِ.',
    ],
  },
  {
    id: 'business',
    ...
    notification: 'صحة فريقك هي سر نجاحك.. وفرنا لك الحل المتكامل!',
    features: [
      '✔️ برنامج مكافآت مخصص: لرفع مستوى رضا الموظفين وولائهم.',
      '✔️ تغطية صحية شاملة: بأسعار تنافسية ومخفضة للمجموعات.',
      '✔️ لوحة تحكم خاصة: للإدارة مع تقارير شهرية دقيقة للشركة.',
      '✔️ مدير حساب مخصص: لتسهيل كافة الإجراءات والدعم الفني.',
      '✔️ خطط مرنة: مفصلة بالكامل حسب احتياج وميزانية منشأتك.',
    ],
  },
];
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 md:p-6 border-b border-slate-200 bg-gradient-to-r from-emerald-50 to-teal-50 flex-shrink-0">
                ...
                <div className="flex-1 text-center">
                  ...
                  {showPackages && (
                    <p className="text-xs md:text-sm text-slate-600 mt-1">
                      اختر التغطية الأنسب لك، وأصدر بطاقتك إلكترونياً خلال ٦٠ ثانية فقط. بلا موافقات مسبقة، وبدون أي قيود للعمر.
                    </p>
                  )}
                  {!showPackages && !showPhoneInput && !showPersonalInfo && !showPayment && !showSuccess && (
                    <p className="text-xs md:text-sm text-slate-600 mt-1">
                      بطاقة واحدة.. توفّر لك حتى ٨٠٪ من نفقاتك الصحية!
                    </p>
                  )}
                </div>
                <button
                  ...
                  <div className="mt-8 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl p-6 md:p-8 text-center shadow-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                      ...
                      <Button
                        ...
                        size="lg"
                        variant="outline"
                        className="border-2 border-black text-black hover:bg-black hover:text-white font-bold w-full sm:w-auto transition-colors"
                      >
