...
const services: NetworkService[] = [
  ...
  {
    id: 'hospitals',
    title: 'نخبة من المستشفيات والمراكز الطبية',
    description: 'شراكات مع نخبة من أكبر المستشفيات والمراكز الطبية في المملكة',
    icon: Hospital,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
  {
    ...
    description: 'شبكة واسعة من أفضل المجمعات والعيادات التخصصية في جميع أنحاء المملكة',
    icon: Stethoscope,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
  {
    ...
    description: 'عيادات متخصصة في طب الأسنان، الجلدية، والتجميل بأحدث التقنيات العالمية',
    icon: Sparkles,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
  {
    id: 'eyes-laser',
    title: 'مراكز العيون والبصريات',
    description: 'شراكة مع أفضل مراكز العيون والبصريات في المملكة لخدمتكم',
    icon: Eye,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
  ...
  },
  {
    id: 'pharmacies',
    title: 'الصيدليات',
    description: 'شراكة مع أكبر الصيدليات في المملكة لتوفير احتياجاتكم الدوائية',
    icon: Pill,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
  {
    ...
    description: 'شراكة واسعة مع أفضل المختبرات الطبية في المملكة لكافة أنواع التحاليل والفحوصات الطبية',
    icon: FlaskConical,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
  ...
  },
  {
    ...
    description: 'تغطية شاملة للعمليات الجراحية بكافة أنواعها في أفضل المستشفيات والمراكز الطبية في أنحاء المملكة',
    icon: Heart,
    badge: 'الشبكة الطبية',
    category: 'medical',
  },
