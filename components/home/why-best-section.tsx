...
const features = [
  ...
  },
  {
    ...
    description: 'لا تتردد في السؤال.. نضمن لك رداً طبياً موثوقاً خلال 15 دقيقة. ولأن صحتك تهمنا، استشارتك الأولى علينا بالكامل.',
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                  {feature.image ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-[192px] md:min-h-[224px]">
