...
const serviceDetails: Record<string, {
  ...
  'membership': {
    ...
    subtitle: 'بوابتك لرعاية طبية استثنائية.. وتوفير ذكي.',
    description: 'لأن صحتك تستحق الأفضل، صممنا لك عضويات تمنحك الأولوية والرعاية الطبية في افضل المستشفيات والمراكز الطبية في المملكة بكل يسر، تمتع براحة البال التي تبحث عنها.',
    features: [
      'خصومات كبرى تصل إلى 80%: تشمل كبرى المستشفيات والمجمعات الطبية في مختلف مناطق المملكة.',
      'شبكة طبية ضخمة: تغطية شاملة تتيح لك الوصول إلى أكثر من 2000 مركز طبي وصحي وتجميلي.',
      'إصدار فوري رقمي: بطاقتك جاهزة للاستخدام في هاتفك خلال ثوانٍ.',
      'راحة بال تامة: تلقَّ العلاج فوراً دون انتظار أي موافقات مسبقة.',
      'رعاية ممتدة: عضوية سنوية تضمن لك الأمان المستمر وسهولة التجديد.'
    ],
    benefits: [
    ...
    pricing: 'استثمر في صحتك.. باقاتنا تبدأ من 299 ريالاً سنوياً فقط'
  },
  'instant-booking': {
